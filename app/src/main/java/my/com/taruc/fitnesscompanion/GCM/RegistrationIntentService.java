package my.com.taruc.fitnesscompanion.GCM;
...
public class RegistrationIntentService extends IntentService {
    ...
    public static final String ACTION_MyIntentService = "my.com.taruc.fitnesscompanion.GCM.Respone";
    public static final String EXTRA_KEY_IN = "GCM_ID";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            token = instanceID.getToken(getString(R.string.gcm_sender),
    ...
    private void sendRegistrationToServer(String token) {
        ...
        //Add Own Server Request to store in PHPMyAdmin
